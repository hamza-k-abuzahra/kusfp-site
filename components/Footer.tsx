      ...
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div className="md:flex md:items-center md:justify-between">
            <div className="flex justify-center space-x-6 md:order-2">
                ...
                {/* <a href="https://chat.whatsapp.com/DHWdeGh7iM35hyFuqYzEpe" target="_blank" className="text-[var(--text-subtle)] hover:text-[var(--text-muted)]">
                ...
                <a href="mailto:ku.sfp23@gmail.com" target="_blank" className="text-[var(--text-subtle)] hover:text-[var(--text-muted)]">
          ...
          <div className="mt-8 md:mt-0 md:order-1">
            <p className="text-center text-base text-[var(--text-subtle)]">&copy; 2026 KUSFP+. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
