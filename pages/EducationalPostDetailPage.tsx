...
const EducationalPostDetailPage: React.FC = () => {
  ...
  const selectedPost = postId ? BLOG_POSTS.find(p => p.id === parseInt(postId, 10)) : null;
  ...
  return (
    <>
      ...
      <PostsCarousel posts={otherPosts} onPostClick={handlePostClick} />
    </>
  );
};
export default EducationalPostDetailPage;