        ...
        translations: {
          ...
          tr: {
            ...
            content: [
              ...
              { type: 'paragraph', text: "Dr. Muzzammil Ayyub Thakur'un açıkladığı gibi, bu an bir iyileşme değil, kontrolün bir dönüşümünü işaret ediyordu: siviller tutuklanmaya devam ediyor, ifade özgürlüğü susturuluyor, medya \"boğuluyor\" ve hatta \"muhalefet fikri bile suç haline getiriliyor.\" Ayrıca, Hindistan'ın \"demografik değişimi zorlamak için yerleşimci sömürge projesini hızlandırdığını\" ve günlük ifade özgürlüğünün kısıtlandığı kadar kısıtlayıcı bir ortam yarattığını vurguluyor. Bugüne kadar, artık yarı özerk bir devlet olmayan Hindistan kontrolündeki Keşmir, Hindistan hükümeti tarafından sıkı kısıtlamalar ve gözetim altında tutulmaya devam etmekte olup, bağımsızlık veya referandumun geri alınması talepleri bastırılmakta ve görmezden gelinmektedir."},
